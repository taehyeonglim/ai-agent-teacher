...
> 이 다이어그램은 강의·연수 자료에 figure로 활용하실 수 있습니다 —
> 고해상도 원본: [img/6d-model.png](img/6d-model.png)
...
- **6D 레이더 프로파일** + 축별 점수 — 각 축의 정의와 함께, 모범적인 한 학기를 100으로 환산한 점수를 구간 배지(● 안정 / ◐ 성장 중 / ○ 돌아볼 지점)로 해석해 줍니다
- 상대적으로 아쉬웠던 2개 축에 대한 **맞춤 처방과 30일 실천 문장**
...
| `node --test tools/*.test.js` | 엔진·점수·복기·검증기 로직 테스트 51개 |
